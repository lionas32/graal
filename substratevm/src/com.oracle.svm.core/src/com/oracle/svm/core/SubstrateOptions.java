...
public class SubstrateOptions {
    ...
    @Option(help = "The GC epoch in which we stop profiling with ROLP.", type = OptionType.Expert)//
    public static final HostedOptionKey<Integer> FinalEpoch = new HostedOptionKey<>(16);
